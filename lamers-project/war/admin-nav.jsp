...
<body>
	<div id="navbar">
		...
		<br><br>
		<a class="navlink" href="/CreateCourse" target="content">Create <%= course %></a>
		<br><br>
		<a class="navlink" href="/ViewRevenue" target="content">View Revenue</a>
		<br><br>
		...
		<br><br>
		<a class="navlink" href="/AssignAward" target="content">Assign Award</a>
		<br><br>
